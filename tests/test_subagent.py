...
from meharness.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from meharness.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from meharness.agents.trace import TraceManager, TraceNode
from meharness.agents.task_manager import BackgroundTask, TaskManager
from meharness.agents.notification import format_task_notification, inject_task_notifications
from meharness.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".meharness" / "agents"
...
class TestPermissionMode:
    def test_dont_ask_mode(self):
        from meharness.permissions.modes import PermissionMode, mode_decide
...
class TestAgentToolParams:
    def test_required_fields(self):
        from meharness.tools.agent_tool import AgentToolParams
