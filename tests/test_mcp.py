...
class TestMCPToolWrapper:
    def test_name_format(self) -> None:
        ...
        from meharness.mcp.tool_wrapper import MCPToolWrapper
        from meharness.mcp.client import MCPClient
...
class TestExtractText:
    def test_text_content(self) -> None:
        from mcp import types as mcp_types
        from meharness.mcp.tool_wrapper import _extract_text
...
class TestMCPManagerPartialFailure:
    ...
    async def test_single_server_failure_does_not_block_others(self) -> None:
        from meharness.mcp.manager import MCPManager
        ...
        with patch("meharness.mcp.manager.MCPClient") as MockClient:
