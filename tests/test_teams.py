...
from meharness.teams.backend_detect import BackendDetectionError, detect_backend
...
class TestAgentCoordinatorIntegration:
    def test_normal_prompt(self):
        from meharness.prompts import build_system_prompt, BASE_PERSONA
    ...
    def test_coordinator_overrides_plan(self):
        from meharness.prompts import build_system_prompt, PLAN_MODE_INSTRUCTIONS
