...
PROJECT_AGENTS_DIR = ".meharness/agents"
USER_AGENTS_DIR = "~/.meharness/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("meharness.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from meharness.agents.parser import parse_frontmatter, _validate_agent_meta
