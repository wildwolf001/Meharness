...
from meharness.teams.mailbox import Mailbox, create_message
...
from meharness.teams.progress import TeammateProgress
from meharness.teams.registry import AgentNameRegistry
from meharness.teams.shared_task import SharedTaskStore
from meharness.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from meharness.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
