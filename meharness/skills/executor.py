...
from meharness.skills.parser import SkillDef, substitute_arguments
from meharness.tools import ToolRegistry

if TYPE_CHECKING:
    from meharness.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from meharness.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
